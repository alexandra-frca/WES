...
from src.utils.plotting2 import plot_est_evol, process_and_plot, sqe_evol_from_file
from src.utils.misc2 import single_warning, print_centered, estimation_errors, logspace
...
class MLQAE(BayesianQAE):
   ...
   '''
    ...
    def maximize_likelihood(self, hs, finish = True, evals = 1e4, excfrom = None):
