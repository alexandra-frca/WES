...
class WES():
    ...
    def adapt_inference(self, 
        ...
        lists
            ...
            times.
        '''
        rd = WESRunData(sampler, self.probing_time)
    ...
    def inference_warmup(self, wNs, TNs, sampler, rd):
        if wNs > 0:
            # Warm up and save data into WESRunData object. 
    ...
    def off_inference(self, sampler, batch = False):
        ...
        s = f"> {method} on the data... [WES.off_inference]"
